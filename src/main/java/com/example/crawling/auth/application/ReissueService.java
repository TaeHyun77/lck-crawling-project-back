package com.example.crawling.auth.application;

import com.example.crawling.auth.domain.RefreshRepository;
...
public class ReissueService {
    ...
    public ResponseEntity<?> reissue(String refreshAuthorization, HttpServletRequest request, HttpServletResponse response) {
        ...
        String newJwt = jwtUtil.createJwt("access", username, role, 1800000L); // 30분
